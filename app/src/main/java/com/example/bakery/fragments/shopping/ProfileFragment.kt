...
import com.example.bakery.activity.LoginRegisterActivity
...
import com.example.bakery.viewmodel.ProfileViewModel
...
class ProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.linearTrackOrder.setOnClickListener {
            val numbers = listOf(8606086464, 9544417444, 9020159893, 9564712454)
            val randomIndex = (0 until numbers.size).random() // Generates a random index within the range of the list size
            val randomNumber = numbers[randomIndex]
            val intent = Intent(Intent.ACTION_DIAL, Uri.parse("tel:$randomNumber"))
